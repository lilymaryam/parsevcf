...
parser.add_argument('-l', '--logging', action='store_true', type=bool, help="if set, logging.debug verbose logging sent to (sample-name).log, else suppress most logging")
